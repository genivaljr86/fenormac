...
(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      username: 'Fenormac',                           // [string or array] required unless using the 'query' option; one or more twitter screen names (use 'list' option for multiple names, where possible)
      ...
      join_text:  '@FERNOMAC',                         // [string]   optional text in between date and tweet, try setting to "auto"
